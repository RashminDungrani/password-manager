...
Revision ID: ab73a1bb9c7b
Revises: 
Create Date: 2022-12-07 14:58:43.465502
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("note", sqlmodel.sql.sqltypes.AutoString(), nullable=True),  # type: ignore
    ...
    op.create_table(
        "ThirdParty",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("signup_cred_id", sa.Integer(), nullable=False),
        sa.Column("signup_with_third_party_cred_id", sa.Integer(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.Column("modified_at", sa.DateTime(), nullable=False),
        sa.Column("deleted_at", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["signup_with_third_party_cred_id"],
            ["Credential.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
